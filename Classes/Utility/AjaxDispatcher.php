 ...
 */
class Tx_RdfExport_Utility_AjaxDispatcher {
	/**
	...
	protected function prepareCallArguments() {
		...
		$this->extensionName    = 'RdfExport';
		$this->pluginName       = 'RdfExport';
...
/** @var $obj Tx_RdfExport_Utility_AjaxDispatcher */
$obj = t3lib_div::makeInstance('Tx_RdfExport_Utility_AjaxDispatcher');
$obj->dispatch();

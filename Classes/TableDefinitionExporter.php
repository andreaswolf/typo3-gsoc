...
/**
 * Exports the definition of a table to 
 *
 * @author Andreas Wolf <andreas.wolf@ikt-werk.de>
 * @package TYPO3
 * @subpackage rdf_export
 */
class Tx_RdfExport_TableDefinitionExporter {
	/**
	...
	public function exportTable($table) {
		 ...
		 * - return as a tree of objects that still have to be rendered
		 */
